  ...
  describe('Element', function () {
    ...
    beforeEach(async function () {
      ...
      nock(td.WD_SERVER_URL_HTTP[browserType])
        ...
        .reply(resp4.code, resp4.body, resp4.headers)
    })
    ...
    describe('click', function () {
      it('should return a success if I click on an existing element ', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/click`)
          .reply(resp.code, resp.body, resp.headers)
      ...
      it('should return a throw an error if the webdriver server return an error ', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID_FAKE}/click`)
          .reply(resp.code, resp.body, resp.headers)
    ...
    describe('clear', function () {
      it('should return a success if I clear an existing element ', async function () {
        ...
        let resp = td.WD_FIND_ELEMENT_RESPONSE.OK
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/clear`)
          .reply(resp.code, resp.body, resp.headers)
      ...
      it('should return a throw an error if the webdriver server return an error ', async function () {
        ...
        element['element-6066-11e4-a52e-4f735466cecf'] = td.WD_ELEMENT_ID_FAKE
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID_FAKE}/clear`)
          .reply(resp.code, resp.body, resp.headers)
      ...
      it('should return an empty string if the server response was successful ', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/property/value`)
          .reply(resp2.code, resp2.body, resp2.headers)
    ...
    describe('sendKeys', function () {
      it('should be successfull if the webdriver server return a response ', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/value`)
          .reply(resp.code, resp.body, resp.headers)
      ...
      it('should return a throw an error if the webdriver server return an error', async function () {
        ...
        element['element-6066-11e4-a52e-4f735466cecf'] = td.WD_ELEMENT_ID_FAKE
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID_FAKE}/value`)
          .reply(resp.code, resp.body, resp.headers)
      ...
      it('should update the text field if the webdriver server return a success ', async function () {
        ...
        //Safari seems to clear the input
        else await expect(element.getValue()).to.become('hellototo')
      })
    })
    ...
    describe('getText', function () {
      it('should return the correct text of the element if webdriver response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/text`)
          .reply(resp.code, resp.body, resp.headers)
    ...
    describe('getValue', function () {
      it('should return the correct text of the element if webdriver response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/property/value`)
          .reply(resp.code, resp.body, resp.headers)
        await expect(element.getValue()).to.be.become(
          td.WD_ELEMENT_GETVALUE.OK.body.value
        )
      })
    ...
    describe('getAttribute', function () {
      it('should return the correct value of the attribute of the element if webdriver response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(
            `/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/attribute/${td.WD_ATTRIBUTE_NAME}`
          )
          .reply(resp.code, resp.body, resp.headers)
        await expect(element.getAttribute(td.WD_ATTRIBUTE_NAME)).to.be.become(
          td.WD_ELEMENT_GETATTRIBUTE.OK.body.value
        )
      })
      ...
      it.skip('should not update the property value if the attribute is updated', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(
            `/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/${td.WD_PROPERTY_NAME}`
          )
          .reply(resp.code, resp.body, resp.headers)
        await expect(element.sendKeys('toto')).to.be.fulfilled
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(
            `/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/property/${td.WD_ATTRIBUTE_NAME}`
          )
          .reply(resp2.code, resp2.body, resp2.headers)
        await expect(element.getAttribute(td.WD_ATTRIBUTE_NAME)).to.become(
          td.WD_ELEMENT_GETATTRIBUTE.OK_UPDATED.body.value
        )
      })
    })
    ...
    describe('getProperty', function () {
      it('should return the correct value of the property of the element if webdriver response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(
            `/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/property/${td.WD_PROPERTY_NAME}`
          )
          .reply(resp.code, resp.body, resp.headers)
      ...
      it.skip('should update the property value if the attribute is updated', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          ...
          .reply(resp2.code, resp2.body, resp2.headers)
        await expect(element.getProperty(td.WD_PROPERTY_NAME)).to.become(
          td.WD_ELEMENT_GETPROPERTY.OK_UPDATED.body.value
        )
      })
    })
    ...
    describe('getTagName', function () {
      it('should return the correct TagName of the element if webdriver response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/name`)
          .reply(resp.code, resp.body, resp.headers)
        if (!nock.isActive() && browserType == 'Safari')
          await expect(element.getTagName()).to.be.become('INPUT')
        else await expect(element.getTagName()).to.be.become('input')
      })
    ...
    describe('getCSSValue', function () {
      it('should return the correct CSS property value of the element if webdriver response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(
            `/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/css/${td.WD_CSS_ATTRIBUTE_NAME}`
          )
          .reply(resp.code, resp.body, resp.headers)
        await expect(element.getCSSValue(td.WD_CSS_ATTRIBUTE_NAME)).to.be.become(
          td.WD_ELEMENT_GETCSSVALUE.OK.body.value
        )
      })
      ...
      it('should throw an error if the webdriver server return an error ', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(
            `/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/${td.WD_ELEMENT_ID}css/${td.WD_CSS_ATTRIBUTE_NAME}`
          )
          .reply(resp.code, resp.body, resp.headers)
    ...
    describe('isSelected', function () {
      it('should return false if an element is not selected if webdriver response is successful 1/3', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/selected`)
          .reply(resp.code, resp.body, resp.headers)
    ...
    describe('findElement', function () {
        ...
        if (using === 'className' || using === 'id' || using === 'name') {
          it(
            ...
            async function () {
              ...
              //@ts-ignore
              await expect(
                l_element.findElement(Using[using], td.WD_ELEMENT_SEARCH[using])
              ).to.be.fulfilled
            }
          )
        } else {
          it(
            ...
            async function () {
              ...
              nock(td.WD_SERVER_URL_HTTP[browserType])
                .post(`/session/${td.WD_SESSION_ID}/element/${l_elementId}/element`)
                .reply(resp.code, resp.body, resp.headers)
              //@ts-ignore
              await expect(
                l_element.findElement(Using[using], td.WD_ELEMENT_SEARCH[using])
      ...
      it('should throw an error if the API return an error | Nock Only', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          ...
          .reply(resp.code, resp.body, resp.headers)
        //@ts-ignore
        await expect(l_element.findElement(Using.css, 'test')).to.be.rejectedWith(
      ...
      it('should find an element before the timeout  | Nock Only', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/element/${l_elementId}/element`)
          .reply(resp2.code, resp2.body, resp2.headers)
        await expect(l_element.findElement(Using.css, '.class_1234', 3000)).to.be
          .fulfilled
      })
      ...
      it('should thrown an error if element is not found before the timeout', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          ...
          .reply(resp2.code, resp2.body, resp2.headers)
        await expect(
          l_element.findElement(Using.css, '.class_dont_exist', 50)
    ...
    describe('findElements', function () {
        ...
        if (using === 'className' || using === 'id' || using === 'name') {
          it(
            ...
            async function () {
              ...
              //@ts-ignore
              await expect(
                l_element.findElements(Using[using], td.WD_ELEMENT_SEARCH[using])
              ).to.be.fulfilled
            }
          )
        } else {
          it(
            ...
            async function () {
              let resp = td.WD_FIND_ELEMENT_RESPONSE.OK
              nock(td.WD_SERVER_URL_HTTP[browserType])
                .post(`/session/${td.WD_SESSION_ID}/element/${l_elementId}/elements`)
                .reply(resp.code, resp.body, resp.headers)
              //@ts-ignore
              await expect(
                l_element.findElements(Using[using], td.WD_ELEMENT_SEARCH[using])
      ...
      it('should throw an error if the API return an error | Nock Only', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          ...
          .reply(resp.code, resp.body, resp.headers)
        //@ts-ignore
        await expect(l_element.findElements(Using.css, 'test')).to.be.rejectedWith(
          /element : this is an unknown error/
        )
      })
      ...
      it('should find an element before the timeout  | Nock Only', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/element/${l_elementId}/elements`)
          .reply(resp2.code, resp2.body, resp2.headers)
        await expect(l_element.findElements(Using.css, '.class_1234', 3000)).to.be
          .fulfilled
      })
      ...
      it('should thrown an error if element is not found before the timeout', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          ...
          .reply(resp2.code, resp2.body, resp2.headers)
        await expect(
          l_element.findElements(Using.css, '.class_dont_exist', 50)
        ).to.be.rejectedWith(/Cannot locate :/)
      })
    ...
    describe('isEnabled', function () {
      it('should return if an element is enabled if webdriver response is successful 1/2', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/enabled`)
          .reply(resp.code, resp.body, resp.headers)
    ...
    describe('screenshot', function () {
      it('should return the image base 64 of the element is enabled if webdriver response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(`/session/${td.WD_SESSION_ID}/element/${td.WD_ELEMENT_ID}/screenshot`)
          .reply(resp.code, resp.body, resp.headers)
