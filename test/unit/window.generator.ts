...
export function generateWindowTest(browserType: string) {
  describe('Windows', function () {
    ...
    beforeEach(async function () {
      ...
      nock(td.WD_SERVER_URL_HTTP[browserType])
        .post(`/session/${td.WD_SESSION_ID}/window`)
    ...
    describe('getSize', function () {
      it('should modify the windows size if the webdriver server response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .get(`/session/${td.WD_SESSION_ID}/window/rect`)
          .reply(resp.code, resp.body, resp.headers)
      ...
      it('should throw an error if the window is closed', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .delete(`/session/${td.WD_SESSION_ID}/window`)
          .reply(resp.code, resp.body, resp.headers)
    ...
    describe('setSize', function () {
      it('should modify the windows size if the webdriver server response is successful', async function () {
        ...
        nock(td.WD_SERVER_URL_HTTP[browserType])
          .post(`/session/${td.WD_SESSION_ID}/window/rect`)
          .reply(resp.code, resp.body, resp.headers)
